...
//
// ✅ Tasks:
// - Implement `Stream` for `CounterStream`
// - Yield values 1 through 3, then end the stream
// - Use `Pin<&mut Self>` and return `Poll<Option<u8>>`
...
// TODO: Implement `Stream` for `CounterStream`
