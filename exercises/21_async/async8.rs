...
// TODO: Implement a blocking "slow" function using thread::sleep
fn slow(name: &str, ms: u64) {
    // TODO: Sleep for `ms` milliseconds
    // Then print: "'<name>' ran for <ms>ms"
}
...
async fn main() {
    let a = async {
        println!("'a' started.");
        slow("a", 30);
        // TODO: yield control here
        slow("a", 10);
        // TODO: yield again
        slow("a", 20);
        // TODO: yield once more
        println!("'a' finished.");
    };
